...
namespace LMS.U_PAL
{
    public partial class addstudentinfo : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataAccessLayer.AddStudentRecord(reg, password, fName, lName, address, city, gender, email, username, GRelation, depart, bGroup, fee, semester, gName, semester);
